...
export const STAR_CATEGORY: Partial<Record<ZiWeiMainStar, 'ji' | 'xiong' | 'neutral'>> = {
  '紫微': 'ji', '天機': 'neutral', '太陽': 'ji', '武曲': 'ji', '天同': 'ji',
  '廉貞': 'neutral', '天府': 'ji', '太陰': 'ji', '貪狼': 'neutral',
  '巨門': 'xiong', '天相': 'ji', '天梁': 'ji', '七殺': 'neutral', '破軍': 'xiong',
};

/** Nayin (納音) five-element lookup for 60 ganzhi → element */
export const NAYIN_ELEMENT: string[] = [
  '金', '金', '火', '火', '木', '木', '水', '水', '土', '土', // 甲子–癸酉
  '土', '土', '金', '金', '火', '火', '木', '木', '水', '水', // 甲戌–癸未
  '土', '土', '金', '金', '火', '火', '木', '木', '水', '水', // 甲申–癸巳
  '土', '土', '金', '金', '火', '火', '木', '木', '水', '水', // 甲午–癸卯
  '土', '土', '金', '金', '火', '火', '木', '木', '水', '水', // 甲辰–癸丑
  '土', '土', '金', '金', '火', '火', '木', '木', '水', '水', // 甲寅–癸亥
];
